...
[`docs/demo.mp4`](docs/demo.mp4) (62.01s, H.264 video + AAC audio, three
ffmpeg chapter markers — Overview / Code Walkthrough / Live Demo — narrated
in `Daniel`, macOS's calm male voice, and presented "on behalf of
...
| Voice | `--voice` | `AGENT_DEMOFORGE_VOICE` | `Daniel` | macOS `say -v` voice name for narration audio. |
...
- `--voice` (default `Daniel`, a calm, soft-spoken macOS male voice) —
