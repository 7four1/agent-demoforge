...
[`docs/demo.mp4`](docs/demo.mp4) (29.31s, H.264 video + AAC audio, narrated
in `Daniel`, macOS's calm male voice, and presented "on behalf of
Srinivasarao Polagani" via `--author-name`,
...
- `--author-name` (default: unset, also configurable via the
  `DEMOFORGE_AUTHOR_NAME` env var) — when set, the demo's intro beat
